        ...
        <div className="grid grid-cols-1 gap-5 mt-5 sm:grid-cols-3">
          {[
            ...
            <FadeUp key={title} delay={delay}>
              <div className="group relative flex h-full min-h-[300px] flex-col justify-between overflow-hidden rounded-[2.5rem] border border-gray-200 bg-white p-10 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-xl">
                <div
                  className="mb-8 flex h-14 w-14 items-center justify-center rounded-2xl transition-transform duration-500 group-hover:-rotate-3 group-hover:scale-110"
                  style={{
                ...
                <div
                  className="pointer-events-none absolute top-1/2 right-[-20%] -translate-y-1/2 opacity-10 transition-opacity duration-300 group-hover:opacity-20"
                  style={{ color: accent }}
                >
                  <Icon className="h-40 w-40 sm:h-44 sm:w-44 md:h-48 md:w-48" strokeWidth={1.5} />
                </div>

                <div
                  className="pointer-events-none absolute inset-0 rounded-[2.5rem] opacity-0 blur-2xl transition-opacity duration-300 group-hover:opacity-100"
                  style={{
                    background: `radial-gradient(circle at 20% 20%, ${accent}12 0%, transparent 55%)`,
                  }}
                />
              </div>
            </FadeUp>
