...
const Footer = () => {
  return (
    <footer className="relative overflow-hidden px-6 md:px-16 lg:px-24 xl:px-32 w-full text-sm text-gray-600 bg-white pt-10"
      style={{ backgroundImage: 'radial-gradient(ellipse 80% 60% at 10% 110%, rgba(121,40,202,0.06) 0%, transparent 60%), radial-gradient(ellipse 60% 50% at 90% 100%, rgba(0,112,243,0.05) 0%, transparent 60%)' }}>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-14">
        ...
        <div className="sm:col-span-2 lg:col-span-1">
          ...
          <p className="text-sm/7 mt-6 text-gray-600">
            Accessify is a platform that helps people discover, review, and understand
            the accessibility of public spaces through real community experiences.
          </p>
        </div>
        ...
        <div className="flex flex-col lg:items-center lg:justify-center">
          <div className="flex flex-col text-sm space-y-2.5">
            ...
            <a
              ...
              href="#"
              onMouseEnter={e => { e.currentTarget.style.backgroundImage = 'linear-gradient(90deg, #FF0080, #7928CA)'; e.currentTarget.style.webkitBackgroundClip = 'text'; e.currentTarget.style.webkitTextFillColor = 'transparent'; }}
              onMouseLeave={e => { e.currentTarget.style.backgroundImage = 'none'; e.currentTarget.style.webkitTextFillColor = ''; }}
            >About Us</a>
            <a
              className="text-gray-600 transition-colors duration-200"
              href="#"
              onMouseEnter={e => { e.currentTarget.style.backgroundImage = 'linear-gradient(90deg, #7928CA, #0070F3)'; e.currentTarget.style.webkitBackgroundClip = 'text'; e.currentTarget.style.webkitTextFillColor = 'transparent'; }}
              onMouseLeave={e => { e.currentTarget.style.backgroundImage = 'none'; e.currentTarget.style.webkitTextFillColor = ''; }}
            >Explore Spaces</a>
            <a
              className="text-gray-600 transition-colors duration-200"
              href="#"
              onMouseEnter={e => { e.currentTarget.style.backgroundImage = 'linear-gradient(90deg, #0070F3, #38BDF8)'; e.currentTarget.style.webkitBackgroundClip = 'text'; e.currentTarget.style.webkitTextFillColor = 'transparent'; }}
              onMouseLeave={e => { e.currentTarget.style.backgroundImage = 'none'; e.currentTarget.style.webkitTextFillColor = ''; }}
            >Accessibility Features</a>
            <a
              className="text-gray-600 transition-colors duration-200"
              href="#"
              onMouseEnter={e => { e.currentTarget.style.backgroundImage = 'linear-gradient(90deg, #FF0080, #0070F3)'; e.currentTarget.style.webkitBackgroundClip = 'text'; e.currentTarget.style.webkitTextFillColor = 'transparent'; }}
              onMouseLeave={e => { e.currentTarget.style.backgroundImage = 'none'; e.currentTarget.style.webkitTextFillColor = ''; }}
            >Reviews</a>
            <a
              className="text-gray-600 transition-colors duration-200"
              href="#"
              onMouseEnter={e => { e.currentTarget.style.backgroundImage = 'linear-gradient(90deg, #7928CA, #FF0080)'; e.currentTarget.style.webkitBackgroundClip = 'text'; e.currentTarget.style.webkitTextFillColor = 'transparent'; }}
              onMouseLeave={e => { e.currentTarget.style.backgroundImage = 'none'; e.currentTarget.style.webkitTextFillColor = ''; }}
            >Contact</a>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm space-y-6 max-w-sm">
            <p className="text-gray-600">Get updates about accessible locations, new features, and community insights.</p>
            <div className="flex items-center">
              ...
              <button
                ...
                onMouseEnter={e => e.currentTarget.style.boxShadow = '0 4px 20px rgba(255,0,128,0.35)'}
                onMouseLeave={e => e.currentTarget.style.boxShadow = '0 2px 12px rgba(121,40,202,0.25)'}
              >
                Subscribe
              </button>
            </div>
      ...
      <div className="flex flex-col md:flex-row items-center justify-between gap-4 py-4 border-t mt-6 border-gray-100">
        <p className="text-center text-gray-400">
          ...
          <a
            ...
            style={{ backgroundImage: 'linear-gradient(90deg, #FF0080, #7928CA)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}
          >
            Accessify
          </a>{' '}
          All Rights Reserved.
